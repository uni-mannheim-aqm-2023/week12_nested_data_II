...
This is the final AQM 2022 lab session! I will be available during regular office hours (Mon, 15:30--17:00) if you want further advice for your term paper.

### Term Paper

Please upload your final term paper on ILIAS. The deadline is June, 15, 10:00.

![ILIAS Upload](images/ILIAS.png)

The paper itself should be `lastname_lastname_AQM22.pdf` (`lastname_lastname_lastname_AQM22.pdf` if you are in a group of three). Your upload should include all code and data that is necessary to replicate your analysis. I highly recommend you to work as you did in the homeworks, i.e. in an R-project environment. If you do so, you can simply zip the folder of your Project and upload it.
...
#### Disadvantage of complete pooling:
  ...
  + In many applications, there are very likely unobserved confounders on the higher level. For causal effect estimation, complete pooling means to assume that there are no relevant differences between the higher level units--an assumption that is often times very unlikely to be true. Think about what this means in your context!
...
This was the final lab session! If you wish to speak to me about your term paper, I will be available in my regular office hours on monday. Please book an appointment.
