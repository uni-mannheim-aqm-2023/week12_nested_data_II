...
This is the final AQM 2023 lab session! We will host longer office hours with three 45 minute slots each (Tue, 15:15--17:30) if you want further advice for your term paper. We found that 15 minute slots are inadequate for discussions of the term paper so close to the deadline.

### Term Paper

Please upload your final term paper on ILIAS. The deadline is June, 14, 10:00 CEST.

![ILIAS Upload](images/ILIAS.png)

The paper itself should be `lastname_lastname_AQM23.pdf` (`lastname_lastname_lastname_AQM23.pdf` if you are in a group of three). Your upload should include all code and data that is necessary to replicate your analysis. I highly recommend you to work as you did in the homeworks, i.e. in an R-project environment. If you do so, you can simply zip the folder of your Project and upload it.
